...
echo "#   scp -r $(hostname):/share/klab/danthes/lemoehlenkam/BLT-VS/analysis_outputs/ann_rdms/${MODEL_NAME}_* ."
echo "#   scp -r $(hostname):/share/klab/danthes/lemoehlenkam/BLT-VS/$SECOND_ORDER_ANN_DIR ."
echo "#   scp -r $(hostname):/share/klab/danthes/lemoehlenkam/BLT-VS/$SECOND_ORDER_MONKEY_DIR ."
echo "#   scp -r $(hostname):/share/klab/danthes/lemoehlenkam/BLT-VS/$(dirname $LOSS_NPZ_PATH) ."
echo "######################################################################"
